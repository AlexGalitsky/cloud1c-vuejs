...
- Загрузки и применения файлов `.dt` (версии баз данных)
...
| `/dashboard` | DashboardView | Главная панель со списком баз |
| `/bases/create` | BaseCreateView | Создание новой базы |
| `/bases/:id/edit` | BaseEditView | Редактирование базы |
| `/bases/:id` | BaseDetailsView | Детали базы, логи, файлы .dt |
...
### 2. Управление базами 1С
- Просмотр списка всех баз с карточками
- Создание новой базы с загрузкой `.dt` файла
...
### 4. Управление версиями (.dt файлы)
- Загрузка файлов при создании/обновлении
- Список всех версий с метаданными (размер, дата)
- Применение выбранной версии
- Удаление версий
